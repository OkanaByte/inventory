...
<script>
    export default {
        ...
        methods:{
            ...
            fetchModel: function () {
                axios.get('../api/brands').then(response => this.brands = _.map(
                    response.data.brands, function(data){
                        return _.pick(data, 'name', 'id');
                    }
                ))
            },
            fetchCategory: function(){
                axios.get('../api/categories').then(response => this.categories = _.map(
                    response.data.categories, function(data){
                        return _.pick(data, 'name', 'id');
                    }
                ))
            },
            ...
            fetchDescriptions: function(){
                axios.get('../api/descriptions').then(response => this.descriptions = _.map(
                    response.data.descriptions, function(data){
                        return _.pick(data, 'name', 'id');
                    }
                ))
            },
